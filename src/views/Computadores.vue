 ...
 <div class="ml-10 mt-10"><h1>Computadores</h1></div>
  ...
  <v-dialog max-width="700px" v-model="dialogCadastroPC">
    <v-card>
      ...
      <v-card-text>
        <v-row class="mt-5">
          <v-col cols="12" sm="6"><v-text-field label="Nome do computador" outlined></v-text-field></v-col>
          <v-col cols="12" sm="6"><v-text-field label="N° de ativo" outlined></v-text-field></v-col>
        </v-row>
      </v-card-text>
...
export default {
  data(){
    return{
      ...
      pc:[
        {nome: "PC 01", nomeuser:"Felipe Mendes", hre:"18:30", hrs:"19:30", status:"Indisponível", color:'error', projeto:"Hackaton"},
        {nome: "PC 02", nomeuser:"Nenhum", hre:"Livre", hrs:"Livre", status:"Disponível", color:'success', projeto:"Nenhum"},
        {nome: "PC 03", nomeuser:"*", hre:"*", hrs:"*", status:"Manutenção", color:'warning', projeto:"*"}
      ],
      desserts: [
          {
            name: 'PC 01',
            usuario:"Felipe Mendes", dtinicio:"18:30", dtfim:"19:30", projeto:"Hackaton", data:"01/07/22"
          },
          {
            name: 'PC 02',
            usuario:"Julia", dtinicio:"19:30", dtfim:"20:30", projeto:"Hackaton", data:"01/07/22"
          },
          {
            name: 'PC 03',
            usuario:"Fernando", dtinicio:"17:30", dtfim:"18:30", projeto:"Hackaton", data:"01/07/22"
          },
          {
            name: 'PC 05',
            usuario:"João", dtinicio:"16:30", dtfim:"17:30", projeto:"Hackaton", data:"01/07/22"
          },
          {
            name: 'PC 06',
            usuario:"Felipa", dtinicio:"14:30", dtfim:"15:30", projeto:"Hackaton", data:"01/07/22"
          },
          {
            name: 'PC 07',
            usuario:"Jorge", dtinicio:"13:30", dtfim:"14:30", projeto:"Hackaton", data:"01/07/22"
          },
          {
            name: 'PC 08',
            usuario:"Maria", dtinicio:"12:30", dtfim:"13:30", projeto:"Hackaton", data:"01/07/22"
          },
          {
            name: 'PC 09',
            usuario:"Gustavo", dtinicio:"11:30", dtfim:"12:30", projeto:"Hackaton", data:"01/07/22"
          },
          {
            name: 'PC 10',
            usuario:"Matheus", dtinicio:"10:30", dtfim:"11:30", projeto:"Hackaton", data:"01/07/22"
          },
        ],
    };
  }
